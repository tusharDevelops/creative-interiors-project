            ...
            <div className="h-64 bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 relative">
              ...
              <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2">
                <div className="bg-white rounded-lg p-4 shadow-lg flex items-center gap-3">
                  ...
                  <span className="text-gray-600 font-medium">Your Custom Design</span>
                </div>
              </div>
            </div>

            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-foreground mb-4">Custom Design Film</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Upload your own design and transform it into premium glass film. Perfect for logos, patterns, or
                artistic designs.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm">Upload any design</span>
                </div>
                <div className="flex items-center gap-3">
                  <Eye className="w-5 h-5 text-brand-pink" />
                  <span className="text-sm">Multiple transparency levels</span>
                </div>
                <div className="flex items-center gap-3">
                  <Layers className="w-5 h-5 text-brand-pink" />
                  <span className="text-sm">Various film styles</span>
                </div>
                <div className="flex items-center gap-3">
                  <Shield className="w-5 h-5 text-brand-pink" />
                  <span className="text-sm">UV protection included</span>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-3xl font-bold text-brand-pink">$12.99</span>
              ...
              <Link href="/custom-shop/glass-film/custom-photo">
          ...
          >
            ...
            <div className="h-64 bg-gradient-to-br from-cyan-200 via-green-200 to-blue-200 relative">
              ...
              <div className="absolute bottom-6 right-6 grid grid-cols-2 gap-2">
                <div className="w-8 h-8 bg-purple-400 rounded opacity-70"></div>
                <div className="w-8 h-8 bg-blue-400 rounded opacity-50"></div>
                <div className="w-8 h-8 bg-green-400 rounded opacity-60"></div>
                <div className="w-8 h-8 bg-cyan-300 rounded opacity-80"></div>
              </div>
            </div>

            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-foreground mb-4">Catalogue Design Film</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Choose from our curated collection of professional glass film designs, patterns, and decorative
                elements.
              </p>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm">Professional patterns</span>
                </div>
                <div className="flex items-center gap-3">
                  <Star className="w-5 h-5 text-brand-cyan" />
                  <span className="text-sm">Privacy & decorative</span>
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-3xl font-bold text-brand-cyan">$9.99</span>
                  <span className="text-sm text-muted-foreground">per sq ft</span>
                </div>
