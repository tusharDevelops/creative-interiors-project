      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-8 animate-slide-in">
          ...
          >
            ...
            Back to Zebra Blinds Options
          </Link>
        </div>

        {/* Header */}
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Zebra Blinds Catalogue</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Explore our collection of zebra blinds with alternating sheer and opaque stripes
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/custom-shop/blinds/zebra-blinds/catalogue-design/${design.id}`}>
