      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-8 animate-slide-in">
          ...
          >
            ...
            Back to Roman Blinds Options
          </Link>
        </div>

        {/* Header */}
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Roman Blinds Catalogue</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Discover our elegant collection of roman blind designs with sophisticated fabric folds
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/custom-shop/blinds/roman-blinds/catalogue-design/${design.id}`}>
