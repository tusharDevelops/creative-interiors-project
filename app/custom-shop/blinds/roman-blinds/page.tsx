        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="relative overflow-hidden border border-gray-200 hover:border-brand-pink/50 transition-all duration-300 hover:shadow-xl animate-fade-in bg-white">
            ...
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Upload your own image to create personalized roman blinds with elegant fabric folds.
              </p>

              <Link href="/custom-shop/blinds/roman-blinds/custom-photo">
          ...
          >
            ...
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Choose from our curated collection of roman blind patterns and elegant designs.
              </p>

              <Link href="/custom-shop/blinds/roman-blinds/catalogue-design">
