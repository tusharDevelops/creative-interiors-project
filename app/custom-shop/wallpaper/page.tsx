        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="relative overflow-hidden border-0 shadow-2xl animate-fade-in">
            ...
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-foreground mb-4">Custom Photo Wallpaper</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Upload your own image and transform it into a premium wallpaper. Perfect for personal photos, artwork,
                or branded designs.
              </p>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-3xl font-bold text-brand-pink">₹70</span>
              ...
              <Link href="/custom-shop/wallpaper/custom-photo">
          ...
          >
            ...
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Choose from our curated collection of professional designs, patterns, and textures created by expert
                designers.
              </p>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-3xl font-bold text-brand-cyan">₹60</span>
                  <span className="text-sm text-muted-foreground">per sq ft</span>
                </div>
              ...
              <Link href="/custom-shop/wallpaper/catalogue-design">
